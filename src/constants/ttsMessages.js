...
export const TTS_MESSAGES = {
  ...
  MAIN_INTRO: {
    ...
    HELP_GUIDE:
      '혼자 하기 어려우시면 화면 중앙의 도움 요청 버튼을 눌러주세요. 보호자나 전문가와 함께 안전하게 진행할 수 있습니다.',

    SAFETY_REMINDER:
      '모든 거래는 실시간으로 안전하게 보호됩니다. 의심스러운 거래가 감지되면 자동으로 알려드리고 차단해드립니다.',

    FIRST_TIME_GUIDE:
      '처음 이용하시는 분은 연습 모드를 먼저 체험해보세요. 실제 돈이 움직이지 않으니 안심하고 연습하실 수 있습니다.',
    ...
    WELCOME_BACK_DETAILED:
      '다시 오셨군요. 오늘은 어떤 업무를 도와드릴까요? 천천히 둘러보시고 필요하시면 언제든 도움을 요청하세요.',
  },

  // 서비스 안내 메시지 (상세화)
  SERVICE_GUIDE: {
    TRANSFER_INFO:
      '이체하기를 선택하시면 안전한 계좌이체를 할 수 있습니다. 사기 계좌는 자동으로 차단되며, 위험한 거래는 보호자에게 알려드립니다.',

    PRACTICE_INFO:
      '연습 모드에서는 실제 돈이 이동하지 않습니다. 처음 사용하시거나 기능을 익히고 싶으실 때 안심하고 연습해보세요.',

    ACCOUNT_INFO:
      '계좌 현황에서는 잔액과 최근 거래 내역을 확인할 수 있습니다. 이상한 거래가 있는지도 함께 점검해드립니다.',

    EDUCATION_INFO:
      '금융교육에서는 요즘 많이 발생하는 금융 사기 예방법과 안전한 금융 이용법을 배울 수 있습니다.',

    SECURITY_INFO:
      '보안설정에서는 계좌 보안을 더욱 강화할 수 있습니다. 비밀번호 변경이나 알림 설정을 관리하실 수 있어요.',

    FAVORITES_INFO:
      '자주 송금하는 계좌를 즐겨찾기에 등록하시면 다음부터 더욱 빠르고 안전하게 이체할 수 있습니다.',
  ...
  HELP_GUIDE: {
    HOW_TO_USE:
      '화면의 버튼들을 천천히 눌러보세요. 각 기능에 대한 음성 설명을 들을 수 있고, 궁금한 점이 있으시면 언제든 도움을 요청하세요.',

    VOICE_CONTROL:
      '음성 안내가 필요하시면 화면 우측 상단의 스피커 모양 버튼을 눌러주세요. 언제든 켜고 끌 수 있습니다.',

    GUARDIAN_HELP:
      '혼자 하기 어려우시면 도움 요청 버튼을 누르세요. 6자리 숫자가 나오면 보호자에게 알려주시면 됩니다. 그러면 함께 화면을 보면서 안전하게 진행할 수 있어요.',

    EMERGENCY_STOP:
      '언제든 위험하다고 느끼시거나 실수했다고 생각되시면 거래를 중단할 수 있습니다. 뒤로가기 버튼이나 홈 버튼을 누르시면 됩니다.',

    STEP_BY_STEP:
      '모든 과정은 단계별로 차근차근 안내해드립니다. 서두르지 마시고 천천히 따라오시면 됩니다.',
  },
  ...
  SUCCESS_MESSAGES: {
    ...
    HELP_CODE_SHARED:
      '도움 코드가 보호자에게 전달되었습니다. 곧 연결될 예정입니다.',
    SAFE_TRANSACTION: '안전한 거래가 확인되었습니다. 계속 진행하셔도 됩니다.',
    TUTORIAL_COMPLETE:
  ...
  TIME_BASED_GUIDE: {
    MORNING_GREETING:
      '좋은 아침입니다. 하루를 시작하기 전에 계좌 상황을 점검해보세요.',
    LUNCH_TIME: '점심시간이네요. 급하지 않은 거래는 나중에 하셔도 됩니다.',
    EVENING_CAUTION:
      '저녁 시간입니다. 늦은 시간의 급한 송금 요청은 사기일 수 있으니 주의하세요.',
    WEEKEND_NOTICE:
      '주말에는 은행 업무가 제한됩니다. 월요일에 처리되는 거래도 있으니 참고하세요.',
  },
  ...
  ACCESSIBILITY_GUIDE: {
    ...
    REPEAT_MESSAGE:
      '방금 안내를 다시 듣고 싶으시면 스피커 버튼을 다시 눌러주세요.',
  },
};
